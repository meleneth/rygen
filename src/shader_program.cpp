...
ShaderProgram::ShaderProgram() { shader_program_id = -1; }
...
bool ShaderProgram::link(GLuint vertex_shader_id, GLuint fragment_shader_id) {
  ...
  //  glProgramParameteriEXT(shader_program_id, GL_GEOMETRY_INPUT_TYPE_EXT,
  //  GL_TRIANGLES);
  //  glProgramParameteriEXT(shader_program_id, GL_GEOMETRY_OUTPUT_TYPE_EXT,
  //  GL_TRIANGLE_STRIP);
  //  glProgramParameteriEXT(shader_program_id, GL_GEOMETRY_VERTICES_OUT_EXT,
  //  3);
  //}
  ///////////////////////////////////////////////////////////////////////////////////////
  ...
  // this is where you could run GetAttribLocation or GetUniformLocation or
  // whaterver
  // calls or BindAttribLocation go ahead and push your program data down to the
  // shader
  // if you run any of these commands again later then you will have to re-link
  // the shader_program
...
void ShaderProgram::activate(void) { glUseProgram(shader_program_id); }

void ShaderProgram::deactivate(void) { glUseProgram(0); }
...
size_t ShaderProgram::size_in_bytes(void) { return 0; }
